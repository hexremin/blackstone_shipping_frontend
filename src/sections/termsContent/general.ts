const generalTerms = `
   <div>
      ...
      <p>Where a Blackstone Shipping Transport Document is issued, the terms and conditions contained or evidenced in such Blackstone Shipping Transport Document shall, in so far as these are inconsistent with the Standard Trading Terms and Conditions, be paramount and govern the services in respect of which the Blackstone Shipping Transport Document is issued. BL TERMS: Blackstone Shipping is operating under the Bill of Lading Terms and Conditions <a href="https://wp.blackstoneshipping.com/files/blackstoneshippin.comBLTERMS.pdf" target="_blank" rel="noopener noreferrer">https://wp.blackstoneshipping.com/files/BLTERMS.pdf</a> of its Bill of Lading or Sea Waybill (depending on which document will be issued for the shipment) and the Blackstone Shipping Tariff Terms and Conditions effective at the time of shipment apply to this quotation. The applicable Terms and Conditions and the Tariff will be provided upon request.</p>
